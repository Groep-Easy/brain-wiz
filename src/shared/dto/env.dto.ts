...
export const EnvironmentSchema = z.object({
  ...
  SERVER_LOCATION: z
    .string()
    .default(DEFAULTS.SERVER_LOCATION),
  ...
  DB_SYNCHRONIZE: z
    .coerce
    .boolean()
    .default(DEFAULTS.DB_SYNCHRONIZE),

  DB_DROP_SCHEMA: z
    .coerce
    .boolean()
    .default(DEFAULTS.DB_DROP_SCHEMA),

  DB_POOL_MIN: z
    .coerce
    .number()
    .default(DEFAULTS.DB_POOL_MIN),

  DB_POOL_MAX: z
    .coerce
    .number()
    .default(DEFAULTS.DB_POOL_MAX),

  DB_QUERY_TIMEOUT: z
    .coerce
    .number()
    .default(DEFAULTS.DB_QUERY_TIMEOUT),

  DB_IDLE_TIMEOUT: z
    .coerce
    .number()
    .default(DEFAULTS.DB_IDLE_TIMEOUT),

  DB_LOG_LEVEL: z
    .string()
    .default(DEFAULTS.DB_LOG_LEVEL),

  DB_LOGGING_ENABLED: z
    .coerce
    .boolean()
    .default(DEFAULTS.DB_LOGGING_ENABLED),

  PGADMIN_DEFAULT_EMAIL: z.email(),
  PGADMIN_DEFAULT_PASSWORD: z.string(),

  SERVER_API_VERSION: z
    .string()
    .default(DEFAULTS.SERVER_API_VERSION),
})
