...
export function WordleGame(props: WordleGameProps): JSX.Element {
  ...
  return (
    <div className="wordle-game">
      ...
      <Keyboard onDelete={onDelete} onKey={onKey} onSubmit={onSubmit} />
    </div>
  )
}
  ...
  return (
    <div className="keyboard">
      ...
      <div className="keyboard keyboard--row3">
        <button className="key key--wide" onClick={onSubmit}>
          ENTER
        </button>
        ...
        <button className="key key--wide" onClick={onDelete}>
          ⌫
        </button>
      </div>
    </div>
...
export function handleUnrealWord(): JSX.Element {
  return <div className="unrealword">This word does not exist!</div>
}

export function handleShortWord(): JSX.Element {
  return <div className="shortword">The word is too short!</div>
}
